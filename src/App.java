...
public class App {
    ...
    public void PawnPromote(Pawn pawn, Board board) {
        ...
        if ((pawn.color.equals("Black") && pawn.row == 0) ||
            ...
            ImageIcon queenImage = pawn.color.equals("White") ? new ImageIcon("white_queen.png") : new ImageIcon("black_queen.png");
            ImageIcon bishopImage = pawn.color.equals("White") ? new ImageIcon("white_bishop.png") : new ImageIcon("black_bishop.png");
            ImageIcon rookImage = pawn.color.equals("White") ? new ImageIcon("white_rook.png") : new ImageIcon("black_rook.png");
            ImageIcon knightImage = pawn.color.equals("White") ? new ImageIcon("white_knight.png") : new ImageIcon("black_knight.png");
